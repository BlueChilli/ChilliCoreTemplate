...
namespace ChilliCoreTemplate.Web
{
    ...
    {
        List<BreadcrumbPathItem> _pathItems;
        public BreadcrumbOptions()
        {
            Status = new Dictionary<string, BreadcrumbStatus>();
            _pathItems = new List<BreadcrumbPathItem>();
        }
        ...
        /// </summary>
        public Dictionary<string, BreadcrumbStatus> Status { get; set; }
    ...
    {
        public static void AddPath(this BreadcrumbOptions options, IUrlHelper urlHelper, string text, IMvcActionDefinition mvcAction)
        {
            var url = mvcAction.Url(urlHelper);
            options.AddPath(new BreadcrumbPathItem() { Text = text, Url = url });
        }

        public static void AddDefaultBreadcrumbItems(this BreadcrumbOptions options, HttpContext httpContext)
        {
