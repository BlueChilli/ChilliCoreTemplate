...
{
    public class ImmediateDispatchEmailQueueTests
    {

        private readonly ITemplateViewRenderer _templateViewRenderer;
        private readonly IServiceProvider _serviceProvider;

        public ImmediateDispatchEmailQueueTests()
        {
            var server = new TestServerFixture<EmailQueueTestStartUp>();
    ...
    public class EmailQueueTestStartUp : IStartup
    {
