...
namespace ChilliCoreTemplate.Data.Migrations
{
    ...
    [Migration("20250722005639_migration_8")]
            ...
            modelBuilder.Entity("ChilliCoreTemplate.Data.EmailAccount.Company", b =>
                {
                    ...
                    b.Property<bool>("IsMasterCompany")
                        .HasColumnType("bit");
                    ...
                    b.Property<bool>("StripeCompleted")
                        .HasColumnType("bit");
                    ...
                    b.HasIndex(new[] { "Guid" }, "IX_Company_Guid")
                        .IsUnique();

                    b.ToTable("Companies", t =>
                        {
                            t.HasCheckConstraint("CK_Companies_MasterCompanyId", "[Id] <> [MasterCompanyId]");
                        });
                });
            ...
            modelBuilder.Entity("ChilliCoreTemplate.Data.EmailAccount.User", b =>
                {
                    ...
                    b.Property<decimal>("FirstNameIndex")
                        .HasPrecision(30)
                    ...
                    b.Property<decimal>("FullNameIndex")
                        .HasPrecision(30)
                        .HasColumnType("decimal(30,0)");
                    ...
                    b.Property<decimal>("LastNameIndex")
                        .HasPrecision(30)
                        .HasColumnType("decimal(30,0)");
                    ...
                    b.HasIndex("FirstNameIndex");

                    b.HasIndex("FullNameIndex");

                    b.HasIndex("LastNameIndex");
            ...
            modelBuilder.Entity("ChilliCoreTemplate.Data.EmailAccount.UserRole", b =>
                {
                    ...
                    b.HasIndex("UserId", "Role", "CompanyId")
                        .IsUnique()
                        .HasFilter("[CompanyId] IS NOT NULL");

                    b.ToTable("UserRoles", t =>
                        {
                            t.HasCheckConstraint("CK_UserRoles_Role", "[Role] > 0");

                            t.HasCheckConstraint("CK_UserRoles_RoleStatus", "[Role] <> 2 or [Status] <> 2");
                        });
                });
